                    ...
                    <div className="dashboardColumn">
                        ...
                        <section className="surfacePanel">
                            ...
                            {room ? (
                                ...
                                <div className="emptyState">
                                    Create a room to make participant state and subtitle sync
                                    visible here.
                                </div>
                            )}
                        </section>
                        ...
                        <section className="surfacePanel">
                            ...
                            {room ? (
                                <div className="shareList">
                                    ...
                                    {hostRoomPlayerUrl && (
                                        <div className="shareCard">
                                            <span className="shareLabel">Local Host URL</span>
                                    ...
                                    {showDebugUrls && (
                                        <>
                                            <div className="shareCard">
                                                <span className="shareLabel">Configured room URL</span>
                                            ...
                                            {localRoomPlayerUrl && (
                                                <div className="shareCard">
                                                    ...
                                                    <p className="shareValue">{localRoomPlayerUrl}</p>
                                                    <button
                                                        className="ghostButton"
                                                        onClick={() => void copyText(localRoomPlayerUrl)}
                                                        type="button"
                                                    >
                                                        Copy local room URL
                                                    </button>
                                            ...
                                            {publicRoomPlayerUrl && (
                                                <div className="shareCard">
                                                    <span className="shareLabel">Public room URL</span>
                                                    <p className="shareValue">{publicRoomPlayerUrl}</p>
                                                    <button
                                                        className="ghostButton"
                                                        onClick={() => void copyText(publicRoomPlayerUrl)}
                                                        type="button"
                                                    >
                                            ...
                                            {publicHostRoomPlayerUrl && (
                                                <div className="shareCard">
                                                    <span className="shareLabel">Public host URL</span>
                                                    <p className="shareValue">{publicHostRoomPlayerUrl}</p>
                                                    <button
                                                        className="ghostButton"
                                                        onClick={() => void copyText(publicHostRoomPlayerUrl)}
                                                        type="button"
                                                    >
                                                        Copy public host URL
                                                    </button>
                                                </div>
                                            )}

                    ...
                    <div className="flex flex-col gap-6">
                        <section className="rounded-[1.75rem] border border-white/70 p-4 shadow-panel sm:rounded-[2rem] sm:p-6">
                            <div className="flex flex-col gap-5">
                                ...
                                {playbackMedia && canPlayMedia ? (
                                    <>
                                        <div className="videoFrame rounded-[1.5rem] bg-slate-950 p-2 text-white shadow-panel sm:p-4">
                                            <video
                                                className="nativeVideoPlayer aspect-video w-full rounded-[1.25rem] bg-black object-contain"
                                                controls
